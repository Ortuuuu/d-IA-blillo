...
def traductorGrosero(texto, historial):
    print(f"Al habla el traductor Grosero.")

    messages = [
        {"role": "system", "content": config.template_traductorGrosero},
    ...
    response = config.client.chat.completions.create(
        ...
        messages = messages,
        tools = tools,
        tool_choice = "auto",  # auto is default, but we'll be explicit (puede ponerse en required para que siempre llame a alguna tool)
    )
